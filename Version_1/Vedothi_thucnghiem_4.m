...
plot(M(:,1),M(:,8),'color',[0.00,0.45,0.74],'linewidth',1.5);

plot(M(:,1),M(:,9),'-.','color',[0.12,0.66,0.12],'linewidth',1.5);
plot(M(:,1),M(:,10),'color',[0.85,0.33,0.10],'linewidth',1.5);
plot(M(:,1),M(:,11),'--','color',[0,0,0],'linewidth',1.5);
xlabel('Thời gian (s)');
...
subplot(2,2,2)
plot(H(:,1),H(:,8),'color',[0.12,0.66,0.12],'linewidth',a);
legend('ADRC+ZV');
xlabel('Thời gian (s)');
ylabel('ω(L,t)(mm)')
axis([0 10 -20 20]);
...
subplot(2,2,3)
plot(H(:,1),H(:,9),'color',[0.85,0.33,0.10],'linewidth',a);
legend('ADRC+ZVD');
xlabel('Thời gian (s)');
ylabel('ω(L,t)(mm)')
axis([0 10 -20 20]);
...
subplot(2,2,2)
plot(K(:,1),K(:,8),'color',[0.12,0.66,0.12],'linewidth',a);
legend('ADRC+ZV');
xlabel('Thời gian (s)');
ylabel('ω(L/2,t)(mm)')
axis([0 10 -10 10]);
...
subplot(2,2,3)
plot(K(:,1),K(:,9),'color',[0.85,0.33,0.10],'linewidth',a);
legend('ADRC+ZVD');
xlabel('Thời gian (s)');
ylabel('ω(L/2,t)(mm)')
axis([0 10 -10 10]);
